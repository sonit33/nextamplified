...
export default function BannerSection({ title, caption, callToAction, ctaLink, hidden }: Props) {
  ...
  return (
    <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 py-2.5 px-6 sm:px-3.5 sm:before:flex-1">
      ...
      >
        ...
        <defs>
          <linearGradient id="49a52b64-16c6-4eb9-931b-8e24bf34e053" x1="614.778" x2="-42.453" y1="26.617" y2="96.115" gradientUnits="userSpaceOnUse">
            <stop stopColor="#86c993" />
            <stop offset={1} stopColor="#19405e" />
          </linearGradient>
        </defs>
      </svg>
      <svg
      ...
      <div className="flex flex-wrap items-center gap-y-2 gap-x-4">
        ...
        <a
          href={ctaLink}
          className="flex-none rounded-full bg-gray-900 py-1 px-3.5 text-sm font-semibold text-dark shadow-sm hover:bg-light focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900"
        >
          {callToAction} <span aria-hidden="true">&rarr;</span>
        </a>
      </div>
      <div className="flex flex-1 justify-end">
        <button type="button" className="-m-3 p-3 focus-visible:outline-offset-[-4px]" onClick={() => setHide(!hide)}>
